...
class DetailsResponse {
  ...
  DetailsEntity toDetailsEntity(){
    return DetailsEntity(
      adult: adult,
      backdropPath: backdropPath,
      belongsToCollection: belongsToCollection,
      budget: budget,
      genres: genres?.map((e) => e.toGenresEntity()).toList(),
      homepage: homepage,
      id: id,
      imdbId: imdbId,
      ...
      productionCompanies: productionCompanies?.map((e) => e.toProductionCompaniesEntity()).toList(),
      productionCountries: productionCountries?.map((e) => e.toProductionCountriesEntity()).toList(),
      releaseDate: releaseDate,
      revenue: revenue,
      runtime: runtime,
      spokenLanguages: spokenLanguages?.map((e) => e.toSpokenLanguagesEntity()).toList(),
      status: status,
      tagline: tagline,
      title: title,
      video: video,
