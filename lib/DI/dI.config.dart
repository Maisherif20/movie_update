...
import '../domain_layer/useCase/moviesUseCase/recommendedMoviesUseCase.dart'
    as _i33;
import '../domain_layer/useCase/searchUseCase.dart' as _i34;
...
import '../presentation_layer/ui/tabs/homeTab/movies/recommendedMovies/recommendedViewModel.dart'
    as _i37;
import '../presentation_layer/ui/tabs/searchTab/searchViewMdel.dart' as _i40;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i34.SearchUseCase>(() =>
        _i34.SearchUseCase(moviesReposatory: gh<_i18.MoviesReposatory>()));
    gh.factory<_i35.PopularMovieViewModel>(() => _i35.PopularMovieViewModel(
          popularMoviesUseCase: gh<_i32.PopularMoviesUseCase>(),
          newReleaseMoviesUseCase: gh<_i31.NewReleaseMoviesUseCase>(),
        ));
    gh.factory<_i36.GenresMoviesUseCase>(() => _i36.GenresMoviesUseCase(
        genresMoviesRepository: gh<_i20.GenresMoviesRepository>()));
    gh.factory<_i37.RecommendedMovieViewModel>(() =>
        _i37.RecommendedMovieViewModel(
            recommendedMoviesUseCase: gh<_i33.RecommendedMoviesUseCase>()));
    gh.factory<_i38.ListenForMovieViewModel>(() => _i38.ListenForMovieViewModel(
        listenForMovieUseCase: gh<_i27.ListenForMovieUseCase>()));
    gh.factory<_i39.MoreLikeViewModel>(() =>
        _i39.MoreLikeViewModel(moreLikeUseCase: gh<_i30.MoreLikeUseCase>()));
    gh.factory<_i40.SearchViewModel>(
        () => _i40.SearchViewModel(searchUseCase: gh<_i34.SearchUseCase>()));
    gh.factory<_i41.AllMoviesViewModel>(() =>
        _i41.AllMoviesViewModel(allMoviesUseCase: gh<_i24.AllMoviesUseCase>()));
    gh.factory<_i42.UpdateMovieViewModel>(() => _i42.UpdateMovieViewModel(
        updateMovieUseCase: gh<_i28.UpdateMovieUseCase>()));
    gh.factory<_i43.AddWatchListViewModel>(() => _i43.AddWatchListViewModel(
        addMovieUseCase: gh<_i23.AddMovieUseCase>()));
    gh.factory<_i44.MovieGenreListViewModel>(() => _i44.MovieGenreListViewModel(
        movieGenreListUseCase: gh<_i22.MovieGenreListUseCase>()));
    gh.factory<_i45.BrowseTabViewModel>(() => _i45.BrowseTabViewModel(
        genresMoviesUseCase: gh<_i36.GenresMoviesUseCase>()));
    gh.factory<_i46.DeleteMovieViewModel>(() => _i46.DeleteMovieViewModel(
        deleteMovieUseCase: gh<_i26.DeleteMovieUseCase>()));
    gh.factory<_i47.CheckInViewModel>(() => _i47.CheckInViewModel(
        checkInFireBaseUseCase: gh<_i25.CheckInFireBaseUseCase>()));
    gh.factory<_i48.DetailsViewModel>(() => _i48.DetailsViewModel(
        moviesDetailsUseCase: gh<_i29.MoviesDetailsUseCase>()));
    gh.factory<_i49.NewReleaseMoviesViewModel>(() =>
        _i49.NewReleaseMoviesViewModel(
            newReleaseMoviesUseCase: gh<_i31.NewReleaseMoviesUseCase>()));
    return this;
  }
}
