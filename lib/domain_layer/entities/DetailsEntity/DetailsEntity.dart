import 'GenresEntity.dart';
import 'ProductionCompaniesEntity.dart';
import 'ProductionCountriesEntity.dart';
import 'SpokenLanguagesEntity.dart';
  ...
  DetailsEntity.fromJson(dynamic json) {
    ...
    if (json['production_companies'] != null) {
      ...
      json['production_companies'].forEach((v) {
        productionCompanies?.add(ProductionCompaniesEntity.fromJson(v));
      });
    }
    if (json['production_countries'] != null) {
      productionCountries = [];
      json['production_countries'].forEach((v) {
        productionCountries?.add(ProductionCountriesEntity.fromJson(v));
      });
    }
    ...
    if (json['spoken_languages'] != null) {
      ...
      json['spoken_languages'].forEach((v) {
        spokenLanguages?.add(SpokenLanguagesEntity.fromJson(v));
      });
    }
    status = json['status'];
